package com.buxz.online_exam.servlet3.business;
...
import com.buxz.online_exam.service.BusinessService;
import com.buxz.online_exam.standard.Util;
...
public class ActionQuestionServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if ("action".equals(action)){
			...
			HttpSession session = req.getSession();
			String username = (String)session.getAttribute(UserInfo.username.toString());
